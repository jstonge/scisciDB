...
def main():
    ROOT_DIR = Path()
    METADATA_DIR = ROOT_DIR / "output" / "metadata_by_decade_all"
    OUTPUT_DIR = ROOT_DIR / "output" / "s2fos_lookup"
    fnames = METADATA_DIR.glob("*has_abstract.jsonl")
    ...
    for i,fname in enumerate(fnames):
        ...
        with open(full_script_path, "w") as f:
                    ...
                    f.write(f"python get_s2fos_lookup.py --fname={str(fname)} --batch_size=75000") 
